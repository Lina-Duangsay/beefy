...
public class Goal {
    ...
    public static final String ALL_GOALS_USERID_INDEX= "AllGoalsUserIdIndex";
    ...
    @DynamoDBIndexHashKey(globalSecondaryIndexName = ALL_GOALS_USERID_INDEX, attributeName = "userId")
